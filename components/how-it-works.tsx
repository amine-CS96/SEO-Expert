...
const steps = [
  {
    ...
    description: "Enter your Website URL and email address in our simple form.",
    step: "01",
    color: "text-blue-500",
  ...
  },
  {
    icon: Cog,
    title: "Fast Analysis",
    description: "Your website is analyzed quickly for SEO and performance issues to provide clear insights.",
    step: "02",
  ...
  
  {
    ...
    description: "Get a comprehensive SEO audit with visual scores, prioritized recommendations,and desktop/mobile screenshots in less than 1 minutes.",
    step: "03",
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Our streamlined process makes it easy to get comprehensive insights about your website performance and
