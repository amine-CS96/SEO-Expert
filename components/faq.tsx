...
const faqs = [
  {
    question: "How long does it take to generate my audit report?",
    answer:
      "Your comprehensive SEO report will be generated in less than 2 minutes after submission. Our automated system works 24/7 to ensure fast turnaround times.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Our audit report includes SEO analysis, performance metrics, mobile optimization insights, security checks, and a detailed action plan with prioritized tasks to help you improve your website effectively.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Our analysis utilizes industry-leading tools and algorithms to deliver highly accurate recommendations. The insights are based on current SEO best practices and Google guidelines.",
  },
  {
