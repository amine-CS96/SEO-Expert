...
import { Search, TrendingUp,Network, Gauge, Shield, Smartphone, BarChart3, Zap, Target, Globe, Share2Icon } from "lucide-react"
...
const features = [
  ...
  },
  {
  ...
  },
   {
    ...
    description: "Enhance your online presence and engagement with tailored strategies and actionable recommendations for your social channels.",
  ...
  return (
    <section className="py-20 bg-muted/30">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        Our comprehensive audit tool analyzes every aspect of your Website to provide
         actionable insights for better performance and user experience.
          </p>
        </motion.div>
