          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="max-w-3xl mx-auto space-y-6">
              <Card className="border-border/50 bg-card/50 backdrop-blur-sm">
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    ...
                    costs or credit card required. You will be able to view your SEO report immediately, in under 2 minutes.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="border-border/50 bg-card/50 backdrop-blur-sm">
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    We're currently developing our Pro Analysis features and expect to launch in Q2 2026. Sign up for
