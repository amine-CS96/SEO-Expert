                  ...
                  <Card className="border-border/50 bg-card/50 backdrop-blur-sm">
                    <CardContent className="flex items-center space-x-4 p-6">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground">seoexpert.clients@gmail.com</p>
                      </div>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="border-border/50 bg-card/50 backdrop-blur-sm">
                    <CardContent className="flex items-center space-x-4 p-6">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground"> +212 778-723996</p>
                      </div>
                    </CardContent>
                  </Card>
                    ...
                    <CardContent className="flex items-center space-x-4 p-6">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground">
                          2nd floor N°6, Safwa Building, Boulevard,
                          <br />
                          Hassan 1st Avenue،
                          <br />
